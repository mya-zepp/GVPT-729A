...
data = as.data.frame(results.p),

title = "Predicted Probability of Voting When Closing Date Changes",
...
# Combine quantiles and means into one matrix
results.p <- cbind(
  "2.5%"  = q[, 1],
...
kable(
  ...
  format = "latex",
  booktabs = TRUE,
  caption = "Predicted Probability of Voting When Closing Date Changes",
  align = c("l", "c", "c", "c"),
  escape = FALSE
) %>%
  kable_styling(
